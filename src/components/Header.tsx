...
export default function Header({ activeProfile, onProfileChange, onOpenSettings, onOpenProfileSetup }: HeaderProps) {
  ...
  return (
    <header className="w-full bg-white/90 backdrop-blur-xl border-b border-white/60 shadow-[0_4px_20px_rgba(0,0,0,0.12)] flex justify-between items-center px-gutter py-3 sticky top-0 z-40">
      ...
      <motion.button
        ...
        className="text-on-surface p-1 active:opacity-70 flex items-center justify-center"
